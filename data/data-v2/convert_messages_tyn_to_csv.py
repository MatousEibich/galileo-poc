...
# Load the JSON file
with open('messages_tyn.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
# Save to CSV
csv_path = 'messages_tyn.csv'
df.to_csv(csv_path, index=False, encoding='utf-8')
print(f'Saved CSV to {csv_path}')

# Save to Excel (XLSX)
excel_path = 'messages_tyn.xlsx'
...
excel_friendly_path = 'messages_tyn_excel_friendly.xlsx'
